...
import com.bootcamp.java.pasivocuentacorriente.service.webClients.activoCreditoEmpresarial.WcActivoCreditoEmpresarialService;
import com.bootcamp.java.pasivocuentacorriente.service.webClients.activoCreditoPersonal.WcActivoCreditoPersonalService;
import com.bootcamp.java.pasivocuentacorriente.service.webClients.activoTarjetaCredito.WcActivoTarjetaCreditoService;
import com.bootcamp.java.pasivocuentacorriente.service.webClients.pasivoAhorro.WcPasivoAhorroService;
import com.bootcamp.java.pasivocuentacorriente.service.webClients.pasivoPlazoFijo.WcPasivoPlazoFijoService;
                    ...
                    return transactionRepository.findTrxPerMoth(Funciones.GetFirstDayOfCurrentMonth()
                            ...
                            .flatMap(trxPerMonth -> {
                                ...
                                switch (transactionRequestDTO.getDestinationIdProduct()){
                                    case 1: {
                                        log.info("Trx Pasivo Cuenta Ahorro hacia Ahorro");
                                    ...
                                    case 2: {
                                        log.info("Trx Pasivo Cuenta Ahorro hacia otra Cuenta Ahorro");
                                        if(transactionRequestDTO.getIdTransactionType() == Constantes.TipoTrxTransferenciaSalida){
                                    ...
                                    case 3: {
                                        log.info("Trx Pasivo Cuenta Ahorro hacia Plazo Fijo");
                                    ...
                                    case 4: {
                                        log.info("Trx Pasivo Cuenta Ahorro hacia Activo Credito Personal");
                                    ...
                                    case 5: {
                                        log.info("Trx Pasivo Cuenta Ahorro hacia Activo Credito Empresarial");
                                    ...
                                    case 6: {
                                        log.info("Trx Pasivo Cuenta Ahorro hacia Activo Tarjeta Credito");
